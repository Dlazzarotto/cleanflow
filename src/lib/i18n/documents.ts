...
export const CONTRACT_I18N: Record<DocLang, {
  ...
  pt: {
    ...
    clauses: [
      ...
      { title: 'CLÁUSULA 2 — RECORRÊNCIA E AGENDAMENTO', body: (p) => `Os serviços serão prestados com frequência ${p.freq}, em dia e horário acordados entre as partes. A duração estimada de cada visita é de ${p.time}, podendo variar conforme as condições do imóvel.` },
  ...
  en: {
    ...
    clauses: [
      ...
      { title: 'SECTION 2 — RECURRENCE AND SCHEDULING', body: (p) => `Services will be provided on a ${p.freq} basis, on days and times agreed by the parties. The estimated duration of each visit is ${p.time} and may vary with the condition of the home.` },
  ...
  es: {
    ...
    clauses: [
      ...
      { title: 'CLÁUSULA 2 — RECURRENCIA Y AGENDAMIENTO', body: (p) => `Los servicios se prestarán con frecuencia ${p.freq}, en días y horarios acordados. La duración estimada de cada visita es de ${p.time} y puede variar según las condiciones del inmueble.` },
  ...
  fr: {
    ...
    clauses: [
      ...
      { title: 'ARTICLE 2 — RÉCURRENCE ET PLANIFICATION', body: (p) => `Les services seront fournis à une fréquence ${p.freq}, aux jours et horaires convenus. La durée estimée de chaque visite est de ${p.time} et peut varier selon l'état du logement.` },
